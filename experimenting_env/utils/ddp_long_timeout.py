...
class DDPPlugin(ParallelPlugin):
    ...
    def _setup_model(self, model: Module) -> DistributedDataParallel:
        ...
        return DistributedDataParallel(
            module=model, device_ids=self.determine_ddp_device_ids(), **self._ddp_kwargs
        )
    ...
    def pre_dispatch(self):
        ...
        self._rank_0_has_called_call_children_scripts = self.broadcast(
    ...
    def _should_run_deadlock_detection(self) -> bool:
        ...
        """
        return (
            os.getenv("PL_RECONCILE_PROCESS", "0") == "1"
            or self._rank_0_has_called_call_children_scripts
        )
